...
node scripts/doc-shots/guide04-minimap.mjs /tmp/doc-shots   # 미니맵 (+ 검증 26항목)
node scripts/doc-shots/guide04-layout-multi.mjs /tmp/doc-shots   # 다중 선택 레이아웃 · 접힘 배지 (+ 검증 11항목)
