...
export const I = {
  ...
  /**
   * 지식창고 — 책 세 권이 꽂힌 책장 (2026-09-18).
   * 퍼블리싱(🌐 Globe, "주소를 만든다")과 **눈에 띄게 달라야** 한다 —
   * 둘은 목적이 다른 두 기능이고, 문서함 행에 나란히 선다.
   */
  Library: (p: P = {}) => (
    <Icon {...p}>
      <rect x="3" y="4" width="4" height="16" rx="1" />
      <rect x="9" y="4" width="4" height="16" rx="1" />
      <path d="M15.5 5.6l3.6-1 3 11.6-3.6 1z" />
  ...
  // 스타일 복사(붓) — 캔버스 툴바 · 커서 옆 표시 (2026-09-19)
  Brush: (p: P = {}) => (
    <Icon {...p}>
      <path d="m14.6 17.9-10.7-2.9" />
      <path d="M18.4 2.6a1 1 0 1 1 3 3l-4 4a.5.5 0 0 0 0 .7l.9 1a2.4 2.4 0 0 1 0 3.4l-.9.9a.5.5 0 0 1-.7 0L8.4 7.3a.5.5 0 0 1 0-.7l.9-.9a2.4 2.4 0 0 1 3.4 0l1 .9a.5.5 0 0 0 .7 0z" />
  ...
  // 이름 변경 — 연필. ✏ 이모지는 윈도에서 아주 작은 막대처럼 보여
  // 무슨 아이콘인지 알 수 없었다 (2026-08-05 실사용 보고).
  Pencil: (p: P = {}) => (
    <Icon {...p}>
      <path d="M12 20h9" />
  ...
  // 다른 폴더로 이동 — 폴더 + 들어가는 화살표
  FolderMove: (p: P = {}) => (
    <Icon {...p}>
      <path d="M3 7a2 2 0 0 1 2-2h3.5l2 2H19a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z" />
      <path d="M9 13h6M13 10.5 15.5 13 13 15.5" />
    </Icon>
  ),
