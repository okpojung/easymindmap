...
| V2 | TRANSLATION (다국어 번역) + COLLAB(실시간 채팅/채팅 번역) | 글로벌 협업 차별화 기능 |
| V3 | DASHBOARD (대시보드 맵) + Node Thread / AI 협업 요약 | 협업 맥락 구조화 + 데이터 시각화 |
...
| EXPORT | 2 | — |
| DASHBOARD (V3) | 5 | — |
| TRANSLATION (V2) | 11 | ⭐ 확장 (TRANS-08~11 추가) |
| AI WORKFLOW | 12 | ⭐ 신규 (WFLOW-01~12) |
| WBS | 5 | ⭐ 신규 (WBS-01~05) |
| RESOURCE | 5 | ⭐ 신규 (RES-01~05) |
| RDMN | 8 | ⭐ 신규 (RDMN-01~08) |
| COLLAB | 17 | ⭐ 확장 (실시간 채팅 / node thread / AI 협업) |
| **합계** | **109+** | |
...
| COLLAB-10 | 실시간 협업 채팅 | 현재 접속 협업자끼리 사용하는 맵 단위 라이브 채팅. unread/read receipt 없음. | V2 |
| COLLAB-11 | 채팅 번역 | 개인 ON/OFF + 원문/번역 동시 표시 + 언어별 캐시 fan-out | V2 |
| COLLAB-12 | Node Thread | 특정 node에 연결된 댓글/대화. 메시지 클릭 시 node focus | V3 |
| COLLAB-13 | AI 댓글 요약 | node thread의 핵심 논점 / 결정 / 미결정 사항 요약 | V3 |
| COLLAB-14 | AI 작업 추출 | action item / 담당자 후보 / 기한 후보 추출 | V3 |
| COLLAB-15 | AI 작업 노드 생성 | 미리보기/승인 후 TODO child node 생성 | V3 |
| COLLAB-16 | 맵 변경 알림 | 멘션 / 다이제스트 / DND / 이메일/Push 알림 | V4 |
| COLLAB-17 | CRDT (Yjs) | Phase 3: 완전한 동시 편집 지원 | V4 |
