...
users
변경
phone_country_code, phone_number, phone_verified 추가


v2.0
map_themes
신규
Typography/Shape/Layout 레벨별 프리셋 저장


v2.0
maps
변경
theme_id UUID FK화, map_config_json JSONB 추가


v2.0
nodes
변경
layout_type CHECK 3종→14종, style_override_json 추가, level 캐시 추가, bg_image_config_json 추가


유지
나머지
유지
node_notes, tags, node_tags, node_links, node_attachments, node_media
