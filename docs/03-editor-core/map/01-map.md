...
기존의 애매한 상태 개념 대신, 이제 MAP은 이렇게 정리된다.
...
* 이것은 **공개/비공개 상태**가 아니라 **맵의 운영/편집 방식**이다
* publish 여부는 별도 기능에서 다룬다
* 즉, **개인 맵도 발행 가능**, **협업 맵도 발행 가능**하다

이제 이 정의를 기준으로 다음 문서들이 자연스럽게 이어진다.

* `23. MAP COLLABORATION`
* `25. PUBLISH_SHARE`

다음은 **2번 NODE_EDITING**으로 넘어가도 되고, 먼저 **MAP 문서 안의 Publishing 관련 경계만 더 분리해서 보강**해도 된다.
