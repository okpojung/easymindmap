...
| 단위 시험 | `apps/api/test/github-docs.test.mjs` (73항목, `test:mcp`) |
...
7. **익명 GitHub 호출은 시간당 60회** — 트리·저장소 정보 2회 + 문서마다 커밋
...
내려감) · 계획(추가·수정·삭제·그대로 · sha 없으면 커밋 시각 · 폴더·문서 범위 ·
