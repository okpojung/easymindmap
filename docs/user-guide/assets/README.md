...
| `04-layout-nested.png` (2026-09-22) | `guide04-layout-nested.mjs` (3레벨 노드 레이아웃 변경 · 엔진·화면 겹침 0 검증 17항목도 함께 돈다) |
...
| `03-connector-canvas.png` · `03-connector-panel.png` · `03-connector-elbow.png` · `03-connector-viewer.png` (2026-09-22) · `03-connector-sides.png` (2026-09-23) | `guide03-connector.mjs` (연결선 만들기·패널·라벨·접힘·삭제·되돌리기·닿는 면·mmd/HTML 왕복 검증 44항목도 함께 돈다) |
